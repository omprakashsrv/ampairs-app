...
dependencies {
    // kspCommonMainMetadata intentionally omitted: Room KSP generates the Database constructor
    // actual per platform; the metadata variant conflicts with the expect object in source.
