...
/**
 * SAFE_QUERY read-only executor for the unit module (FR-016). Runs an already-validated `SELECT`
 * against the unit DB on a Room **reader** connection.
 */
@Inject
@ContributesIntoMap(WorkspaceScope::class)
@QueryExecutorKey("unit")
class UnitQueryExecutor(
    private val database: UnitDatabase,
) : ModuleQueryExecutor {

    override val moduleName: String = "unit"
