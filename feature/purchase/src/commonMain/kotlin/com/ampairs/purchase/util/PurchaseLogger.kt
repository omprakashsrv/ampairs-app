package com.ampairs.purchase.util
...
/**
 * Domain logger for the purchase module. Mirrors CustomerLogger — use the 3-param `w/e/i/d`
 * methods (NOT warn/error) so call sites match the project logger contract.
 */
