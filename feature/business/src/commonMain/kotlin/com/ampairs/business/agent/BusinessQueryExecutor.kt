...
/**
 * SAFE_QUERY read-only executor for the business module (FR-016). Runs an already-validated `SELECT`
 * against the business DB on a Room **reader** connection.
 */
@Inject
@ContributesIntoMap(WorkspaceScope::class)
@QueryExecutorKey("business")
class BusinessQueryExecutor(
    private val database: BusinessDatabase,
) : ModuleQueryExecutor {

    override val moduleName: String = "business"
