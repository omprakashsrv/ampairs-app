...
import ampairsapp.feature.auth.generated.resources.code
import ampairsapp.feature.auth.generated.resources.phone

/**
 * Phone input composable for the auth feature module.
 * Self-contained version that doesn't depend on composeApp components.
 */
@Composable
fun Phone(
    countryCode: Int,
