package com.ampairs.store.util

import com.ampairs.common.sentry.ErrorTracking
import com.ampairs.common.sentry.SentryLevel

/**
 * KMP-compatible logger for the Store (settings) module. Errors/warnings with exceptions are
 * reported to Sentry. Method names are w/e/i/d (not warn/error).
 */
object StoreLogger {
