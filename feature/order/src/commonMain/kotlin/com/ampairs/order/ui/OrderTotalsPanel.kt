...
/**
 * Sticky GST totals + price-mode toggle + overall-discount control.
 * Recreated in Material 3 from the Order/Invoice design prototype (TotalsPanel + Header price mode).
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun OrderTotalsPanel(
    totals: TotalsUi,
    ...
    Surface(
        ...
        Column(Modifier.padding(16.dp)) {
            // ── price mode (Tax-exclusive / Tax-inclusive) ──
            ...
            Row(Modifier.padding(top = 12.dp), verticalAlignment = Alignment.CenterVertically) {
                ...
                Text(
                    "  Reconciles · taxable + GST = grand total",
                    style = MaterialTheme.typography.labelSmall,
                    color = cs.onSurfaceVariant,
                )
            }
