...
fun List<OrderApiModel>.asDatabaseModel(): List<OrderEntity> {
    return map { orderApiModel ->
        OrderEntity(
            ...
            customer_id = orderApiModel.customerId,
            customer_name = orderApiModel.customerName,
            invoice_ref_id = orderApiModel.invoiceRefId,
            customer_gst = orderApiModel.customerGst,
            customer_phone = orderApiModel.customerPhone,
            seller_name = orderApiModel.sellerName,
