...
interface ProductDao {
    ...
    /**
     * Search + multi-select filter (brand / category / sub-category / group) in a single query. The
     * text query matches product name, code (SKU), or description (substring, case-insensitive). Each
