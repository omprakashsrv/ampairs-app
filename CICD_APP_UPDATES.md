...
Code signing certificates are **purchased from Certificate Authorities** (not generated by the workflow).

**📖 Complete Setup Guide:** See [WINDOWS_CODE_SIGNING_SETUP.md](WINDOWS_CODE_SIGNING_SETUP.md) for:
- Where to purchase certificates ($70-500/year)
- Step-by-step identity verification process
- How to export and convert to base64
