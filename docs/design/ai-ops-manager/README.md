...
| 2 | Capitalization/format + customer field validation (**email** + **phone** normalization) | [02-customer-email-normalization.md](02-customer-email-normalization.md), [05-customer-phone-normalization.md](05-customer-phone-normalization.md) | in progress |
