...
| 2 | Capitalization/format + customer field validation (first piece: **customer email normalization**) | [02-customer-email-normalization.md](02-customer-email-normalization.md) | in progress |
