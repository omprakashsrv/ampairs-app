...
| 2 | Capitalization/format + field validation — normalizers: customer **email/phone/GSTIN/name**, product **code/name** (shared `FieldNormalizationCapability` base); **advisory/completeness** checks: customer **contact** (shared `AdvisoryCapability` base) | [02](02-customer-email-normalization.md), [05](05-customer-phone-normalization.md), [06](06-product-code-normalization.md), [07](07-customer-gst-normalization.md), [08](08-customer-name-normalization.md), [09](09-field-normalization-base.md), [10](10-product-name-normalization.md), [11](11-advisory-capabilities.md) | in progress |
