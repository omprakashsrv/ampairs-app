package com.ampairs.common.validation.email
...
sealed class EmailValidationError(override val details: String? = null) : ValidationError {
     ...
     */
    object InputIsNull :
        EmailValidationError(details = "Input is not a valid Email Address because it is null.")

    /**
     * The provided input value to the [EmailValidator] was not in a valid email address format.
     */
    object InvalidFormat :
        EmailValidationError(details = "Input is not in a valid Email Address Format.")
}